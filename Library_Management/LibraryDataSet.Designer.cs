...
namespace Library_Management {
    ...
    public partial class LibraryDataSet : global::System.Data.DataSet {
        ...
        public partial class booksDataTable : global::System.Data.TypedTableBase<booksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public booksRow AddbooksRow(string name, string author, string category, string edition, decimal price) {
...
namespace Library_Management.LibraryDataSetTableAdapters {
    ...
    public partial class booksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[books] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_author = 1 AND [author] IS NULL) OR ([author] = @Original_author)) AND ((@IsNull_category = 1 AND [category] IS NULL) OR ([category] = @Original_category)) AND ((@IsNull_edition = 1 AND [edition] IS NULL) OR ([edition] = @Original_edition)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[books] ([name], [author], [category], [edition], [price]) VALU" +
                "ES (@name, @author, @category, @edition, @price);\r\nSELECT Id, name, author, cate" +
                "gory, edition, price FROM books WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[books] SET [name] = @name, [author] = @author, [category] = @category, [edition] = @edition, [price] = @price WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_author = 1 AND [author] IS NULL) OR ([author] = @Original_author)) AND ((@IsNull_category = 1 AND [category] IS NULL) OR ([category] = @Original_category)) AND ((@IsNull_edition = 1 AND [edition] IS NULL) OR ([edition] = @Original_edition)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)));
SELECT Id, name, author, category, edition, price FROM books WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, author, category, edition, price FROM dbo.books";
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_author, string Original_category, string Original_edition, global::System.Nullable<decimal> Original_price) {
        ...
        public virtual int Insert(string name, string author, string category, string edition, global::System.Nullable<decimal> price) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string author, string category, string edition, global::System.Nullable<decimal> price, int Original_Id, string Original_name, string Original_author, string Original_category, string Original_edition, global::System.Nullable<decimal> Original_price, int Id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string author, string category, string edition, global::System.Nullable<decimal> price, int Original_Id, string Original_name, string Original_author, string Original_category, string Original_edition, global::System.Nullable<decimal> Original_price) {
            return this.Update(name, author, category, edition, price, Original_Id, Original_name, Original_author, Original_category, Original_edition, Original_price, Original_Id);
        }
    }
